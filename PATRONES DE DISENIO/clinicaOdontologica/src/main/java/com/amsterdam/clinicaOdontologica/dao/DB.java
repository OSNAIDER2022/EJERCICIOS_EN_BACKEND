...
public class DB {
    private static final String SQL_DROP_CREATE_TABLES = "DROP TABLE IF EXISTS PACIENTES, DOMICILIOS;"+
            ...
            "CREATE TABLE PACIENTES(ID INT PRIMARY KEY AUTO_INCREMENT, NOMBRE VARCHAR(100) NOT NULL, APELLIDO VARCHAR(100) NOT NULL, IDENTIFICACION VARCHAR(100) NOT NULL, FECHA_INGRESO DATE NOT NULL, DOMICILIO_ID INT NOT NULL, EMAIL VARCHAR(100) NOT NULL);";

    private static final String SQL_DE_PRUEBAS = "INSERT INTO DOMICILIOS(CALLE, NUMERO, LOCALIDAD, PROVINCIA) VALUES('Elm Street','234','prouned','Arizona');"+
            "INSERT INTO PACIENTES(NOMBRE, APELLIDO, IDENTIFICACION, FECHA_INGRESO, DOMICILIO_ID, EMAIL) VALUES('Jeremy','Hantzel','67dhh5h56','2022-11-15',1,'prueba@gmail.com');";
